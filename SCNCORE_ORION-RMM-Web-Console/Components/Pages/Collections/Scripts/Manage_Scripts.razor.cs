...
namespace SCNCORE_ORION_RMM_Web_Console.Components.Pages.Collections.Scripts
{
    public partial class Manage_Scripts
    {
        ...
        private async Task<bool> Permissions()
        {
            try
            {
                ...
                permissions_collections_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "collections_enabled");
                permissions_collections_scripts_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "collections_scripts_enabled");
                permissions_collections_scripts_add = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "collections_scripts_add");
                permissions_collections_scripts_edit = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "collections_scripts_edit");
                permissions_collections_scripts_delete = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "collections_scripts_delete");
