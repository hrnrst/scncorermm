...
namespace SCNCORE_ORION_RMM_Web_Console.Components.Pages.Devices
{
    public partial class Devices
    {
        ...
        private string SCNCORE_ORION_username = String.Empty;
        ...
        private async Task<bool> Permissions()
        {
            try
            {
                ...
                SCNCORE_ORION_username = user.FindFirst(ClaimTypes.Email)?.Value;

                token = await Classes.Authentication.User.Get_Remote_Session_Token(SCNCORE_ORION_username);

                permissions_devices_authorized_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_authorized_enabled");
                permissions_devices_general = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_general");
                permissions_devices_software = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_software");
                permissions_devices_task_manager = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_task_manager");
                permissions_devices_antivirus = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_antivirus");
                permissions_devices_events = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_events");
                permissions_devices_remote_shell = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_remote_shell");
                permissions_devices_remote_file_browser = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_remote_file_browser");
                permissions_devices_remote_control = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_remote_control");
                permissions_devices_deauthorize = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_deauthorize");
                permissions_devices_move = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "devices_move");
                permissions_tenants_list = await Classes.Authentication.Permissions.Get_Tenants(SCNCORE_ORION_username, true);
                ...
                if (tenant_guid == "all")
                {
                    has_all_tenants_permission = await Classes.Authentication.Permissions.Verify_Tenants_Full_Access(SCNCORE_ORION_username);
...
WHERE device_id = @deviceId");
        ...
        public async Task Remote_Setup_SignalR()
        {
            try
            {
                ...
                //this.Snackbar.Add(Localizer["connected_with_SCNCORE_ORION_remote_server"].ToString(), Severity.Info);
            }
            catch (Exception ex)
            {
