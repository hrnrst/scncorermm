...
namespace SCNCORE_ORION_RMM_Web_Console.Components.Pages.Settings.Notifications
{
    ...
    {            
        ...
        private async Task<bool> Permissions()
        {
            try
            {
                ...
                string SCNCORE_ORION_username = user.FindFirst(ClaimTypes.Email)?.Value;

                permissions_settings_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_enabled");
                permissions_settings_notifications_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_enabled");
                permissions_settings_notifications_mail_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_mail_enabled");
                permissions_settings_notifications_mail_add = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_mail_add");
                permissions_settings_notifications_mail_smtp = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_mail_smtp");
                permissions_settings_notifications_mail_test = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_mail_test");
                permissions_settings_notifications_mail_edit = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_mail_edit");
                permissions_settings_notifications_mail_delete = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_mail_delete");
                permissions_settings_notifications_microsoft_teams_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_microsoft_teams_enabled");
                permissions_settings_notifications_microsoft_teams_add = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_microsoft_teams_add");
                permissions_settings_notifications_microsoft_teams_test = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_microsoft_teams_test");
                permissions_settings_notifications_microsoft_teams_edit = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_microsoft_teams_edit");
                permissions_settings_notifications_microsoft_teams_delete = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_microsoft_teams_delete");
                permissions_settings_notifications_telegram_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_telegram_enabled");
                permissions_settings_notifications_telegram_add = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_telegram_add");
                permissions_settings_notifications_telegram_test = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_telegram_test");
                permissions_settings_notifications_telegram_edit = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_telegram_edit");
                permissions_settings_notifications_telegram_delete = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_telegram_delete");
                permissions_settings_notifications_ntfysh_enabled = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_ntfysh_enabled");
                permissions_settings_notifications_ntfysh_add = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_ntfysh_add");
                permissions_settings_notifications_ntfysh_test = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_ntfysh_test");
                permissions_settings_notifications_ntfysh_edit = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_ntfysh_edit");
                permissions_settings_notifications_ntfysh_delete = await Classes.Authentication.Permissions.Verify_Permission(SCNCORE_ORION_username, "settings_notifications_ntfysh_delete");
        ...
        private async Task Send_Mail(string mail_address)
        {
            ...
            string result = await Classes.Helper.Notifications.Smtp.Send_Mail(mail_address, "SCNCORE_ORION RMM - Test Alert", "Test.");
        ...
        private async Task Send_Microsoft_Teams_Message(string id, string connector_name)
        {
            ...
            string result = await Classes.Helper.Notifications.Microsoft_Teams.Send_Message(id, "SCNCORE_ORION RMM Alert: Test.<br>Connector Name: " + connector_name);
        ...
        private async Task Send_Telegram_Message(string id, string bot_name)
        {
            ...
            string result = await Classes.Helper.Notifications.Telegram.Send_Message(id, "SCNCORE_ORION RMM Alert: Test.\nBot Name: " + bot_name);
        ...
        private async Task Send_Ntfy_sh_Message(string id, string topic_name)
        {
            ...
            string result = await Classes.Helper.Notifications.Ntfy_sh.Send_Message(id, "SCNCORE_ORION RMM Alert: Test.\nTopic Name: " + topic_name);
