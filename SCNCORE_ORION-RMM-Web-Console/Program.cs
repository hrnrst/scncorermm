...
// Title
Web_Console.title = builder.Configuration.GetValue<string>("Webinterface:Title", "SCNCOREORION RMM");

if (Web_Console.title == "Your company name")
    Web_Console.title = "SCNCOREORION RMM"; // Default title if not set

var language = builder.Configuration["Webinterface:Language"];

// Check license code signed
//OSSCH_START 97d9dd72-e437-4a01-be82-1a7b088e592a //OSSCH_END
...
// Output version
Console.WriteLine("SCNCOREORION RMM Web Console");
...
else if (!microsoft_defender_firewall_status && OperatingSystem.IsWindows())
{
    ...
    Console.WriteLine("Microsoft Defender Firewall is disabled. You should enable it for your own safety. SCNCOREORION adds firewall rules automatically according to your configuration.");
}
...
//OSSCH_START 04a2b895-c091-486c-9607-a420c59b5600 //OSSCH_END
