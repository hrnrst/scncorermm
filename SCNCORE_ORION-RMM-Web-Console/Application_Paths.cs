...
namespace SCNCORE_ORION_RMM_Web_Console
{
    ...
    {
        //public static string logs_dir = @"C:\ProgramData\0x101 Cyber Security\SCNCORE_ORION RMM\Web Console\Logs";
        public static string logs_dir = Path.Combine(GetBasePath(), "0x101 Cyber Security", "SCNCORE_ORION RMM", "Web Console", "Logs");
        ...
        public static string SCNCORE_ORION_rmm_logo_svg_path = Path.Combine(Environment.CurrentDirectory, "wwwroot", "media", "images", "SCNCORE_ORION-RMM-Logo-Transparent.svg");
        public static string SCNCORE_ORION_rmm_logo_png_path = Path.Combine(Environment.CurrentDirectory, "wwwroot", "media", "images", "SCNCORE_ORION-RMM-Logo-Transparent.png");
        ...
        //public static string debug_txt_path = @"C:\ProgramData\0x101 Cyber Security\SCNCORE_ORION RMM\Web Console\debug.txt";
