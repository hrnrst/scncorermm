    ...
    public class AutoCleanupService : BackgroundService
    {
        ...
        private async Task Clean()
        {
            try
            {
                ...
                MySqlConnection conn = new MySqlConnection(SCNCORE_ORION_RMM_Web_Console.Configuration.MySQL.Connection_String);
                ...
                if (cleanup_applications_drivers_history_enabled)
                {
                    ...
                    await SCNCORE_ORION_RMM_Web_Console.Classes.MySQL.Handler.Execute_Command(query);
                }
