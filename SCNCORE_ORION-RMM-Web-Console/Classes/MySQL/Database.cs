...
namespace SCNCORE_ORION_RMM_Web_Console.Classes.MySQL
{
    public class Database
    {
        ...
        // Check if MySQL is used (not MariaDB) and if the version is supported by SCNCORE_ORION
        ...
        public static async Task<string> Check_SCNCORE_ORION_Database_Version()
        {
            MySqlConnection conn = new MySqlConnection(Configuration.MySQL.Connection_String);
  ...
  ""collections_files_SCNCORE_ORION"": true,
  ""events_enabled"": true,
  ""users_enabled"": true,
  ""users_add"": true,
  ""users_manage"": true,
