...
{
    private readonly SymmetricSecurityKey _signingKey = new(Encoding.UTF8.GetBytes(SCNCORE_ORION_RMM_Web_Console.Configuration.Web_Console.token_service_secret_key));
