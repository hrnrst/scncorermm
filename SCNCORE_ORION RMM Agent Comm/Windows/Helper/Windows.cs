    ...
    internal class Windows
    {
        public static string Windows_Version()
        {
            ...
            try
            {
                ...
                // If the build number is greater than or equal to 22000, it is Windows 11. Older windows 11 versions had wrong product names, stating they are windows 11. Knowlege from SCNCORE_ORION Legacy
            ...
            {
                Logging.Error("SCNCORE_ORION_RMM_Comm_Agent_Windows.Helper.Windows.Windows_Version", "Collect windows product name & version", ex.Message);
                return "-";
            }
        }
