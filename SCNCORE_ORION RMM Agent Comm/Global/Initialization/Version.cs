        ...
        public static async Task Update()
        {
            try
            {
                ...
                if (Directory.Exists(Application_Paths.c_temp_SCNCORE_ORION_dir))
                    Directory.Delete(Application_Paths.c_temp_SCNCORE_ORION_dir, true);
                ...
                await Http.DownloadFileAsync(Configuration.Agent.ssl, Device_Worker.update_server + installer_package_url, Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.installer_package_path), Configuration.Agent.package_guid);
                ...
                string downloaded_hash = IO.Get_SHA512(Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.installer_package_path));
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.installer_package_path), Application_Paths.c_temp_installer_dir, true);
