...
namespace SCNCORE_ORION_RMM_Server.Agent.Windows
{
    public class Authentification
    {
        ...
        public static async Task<string> Verify_Device(string json, string ip_address_external, bool update)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Authentification.Verify_Device", "General error", ex.ToString());
                return "invalid";
            }
            finally
            {
        ...
        public static async Task<bool> Verify_Admin(string username, string password)
        {
            ...
            try
            {
                ...
                Logging.Handler.Debug("SCNCORE_ORION_RMM_Server.Modules.Authentification.Verify_Admin", "isPasswordCorrect", isPasswordCorrect.ToString());
        ...
        public static async Task<bool> Verify_SCNCORE_ORION_Package_Configurations_Guid(string guid)
        {
            ...
            try
            {
                ...
                Logging.Handler.Debug("SCNCORE_ORION_RMM_Server.Modules.Authentification.Verify_SCNCORE_ORION_Package_Configurations_Guid", "count", count.ToString());

                if (count > 0)
                    isCorrect = true;
                
                Logging.Handler.Debug("SCNCORE_ORION_RMM_Server.Modules.Authentification.Verify_SCNCORE_ORION_Package_Configurations_Guid", "isCorrect", isCorrect.ToString());

                return isCorrect;
            }
            catch (Exception ex)
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Authentification.Verify_SCNCORE_ORION_Package_Configurations_Guid", "General error", ex.ToString());
                return false;
            }
            finally
            {
            ...
            public async Task InvokeAsync(HttpContext context)
            {
                ...
                try
                {
                    ...
                    if (hasDeviceIdentity)
                    {
                        ...
                        // Verify package guid
                        bool package_guid_status = await Verify_SCNCORE_ORION_Package_Configurations_Guid(device_identity.package_guid);
                ...
                {
                    Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Authentification.InvokeAsync", "General error", ex.ToString());
