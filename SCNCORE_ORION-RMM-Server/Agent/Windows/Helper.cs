...
namespace SCNCORE_ORION_RMM_Server.Agent.Windows
{
    public class Helper
    {
        ...
        public static async Task<(int, int)> Get_Tenant_Location_Id(string tenant_guid, string location_guid)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Tenant_Location_Id", "General error", ex.ToString());
                return (0, 0);
            }
            finally
            {
        ...
        public static async Task<(string, string)> Get_Tenant_Location_Name(int tenant_id, int location_id)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Tenant_Location_Name", "General error", ex.ToString());
        ...
        public static async Task<int> Get_Device_Id(string device_name, int tenant_id, int location_id)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Device_Id", "General error", ex.ToString());
                return 0;
            }
            finally
            {
        ...
        public static async Task<bool> Get_Role_Status(string role)
        {
            try
            {
                Logging.Handler.Debug("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Role_Status", "role", role);
                
                string json = File.ReadAllText("appsettings.json");
                Logging.Handler.Debug("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Role_Status", "appsettings.json", json);
                ...
                using (JsonDocument document = JsonDocument.Parse(json))
                {
                    ...
                    Logging.Handler.Debug("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Role_Status", "role_status", role_status.ToString());
                    return role_status;
                }
            }
            catch (Exception ex)
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Role_Status", "General error", ex.ToString());
                return false;
            }
        }
        ...
        public static async Task<bool> Get_Uptime_Monitoring_Status(int device_id)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Helper.Get_Uptime_Monitoring_Status", "General error", ex.ToString());
                return false;
            }
            finally
            {
        ...
        public static string Truncate(string? value, int maxLength = 255)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Helper.Truncate", "General error", ex.ToString());
                return string.Empty;
            }
        }
    }
