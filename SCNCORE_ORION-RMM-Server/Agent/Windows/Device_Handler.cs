...
using static SCNCORE_ORION_RMM_Server.Agent.Windows.Device_Handler;
    ...
    public class Device_Handler
    {
        ...
        public static async Task<string> Update_Device_Information(string json)
        {
            ...
            try
            {
                ...
                {
                    Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Modules.Authentification.Verify_Device", "Result", ex.Message);
                }
