...
// Members Portal Api
var membersPortal = builder.Configuration.GetSection("Members_Portal_Api").Get<SCNCORE_ORION_RMM_Server.Members_Portal.Config>() ?? new SCNCORE_ORION_RMM_Server.Members_Portal.Config();
