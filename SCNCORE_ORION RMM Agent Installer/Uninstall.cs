    ...
    internal class Uninstall
    {
        public static void Clean()
        {
            ...
            if (OperatingSystem.IsWindows())
            {
                ...
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION RMM User Process.exe"); // kill legacy process
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION RMM User Process.exe\""); // kill legacy process
            ...
            if (OperatingSystem.IsWindows())
            {
                ...
                Logging.Handler.Debug("Main", "Unregistering user process", "SCNCORE_ORION RMM User Process");
                Windows.Helper.Registry.HKLM_Delete_Value(Application_Paths.hklm_run_directory_reg_path, "SCNCORE_ORION RMM User Process");
            }
            else if (OperatingSystem.IsLinux())
            {
