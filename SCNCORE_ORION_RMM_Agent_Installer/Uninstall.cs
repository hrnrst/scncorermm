...
namespace SCNCORE_ORION_RMM_Agent_Installer
{
    internal class Uninstall
    {
        public static void Clean()
        {
            ...
            {
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCORE_ORION_RMM_Agent_Comm");
                Helper.Service.Stop("SCNCORE_ORION_RMM_Agent_Comm");
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCORE_ORION_RMM_Agent_Remote");
                Helper.Service.Stop("SCNCORE_ORION_RMM_Agent_Remote");
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCORE_ORION_RMM_Agent_Health");
                Helper.Service.Stop("SCNCORE_ORION_RMM_Agent_Health");

                // For legacy installations (2.0.0.0)
                Logging.Handler.Debug("Main", "Stopping services (legacy).", "SCNCORE_ORION_RMM_Comm_Agent_Windows");
                Helper.Service.Stop("SCNCORE_ORION_RMM_Comm_Agent_Windows");
                Logging.Handler.Debug("Main", "Stopping services (legacy).", "SCNCORE_ORION_RMM_Health_Agent_Windows");
                Helper.Service.Stop("SCNCORE_ORION_RMM_Health_Agent_Windows");
                Logging.Handler.Debug("Main", "Stopping services (legacy).", "SCNCORE_ORION_RMM_Remote_Agent_Windows");
                Helper.Service.Stop("SCNCORE_ORION_RMM_Remote_Agent_Windows");
            }
            else if (OperatingSystem.IsLinux())
            {
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCORE_ORION-rmm-agent-comm");
                Bash.Execute_Script("Stopping services", false, "systemctl stop SCNCORE_ORION-rmm-agent-comm");
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCORE_ORION-rmm-agent-remote");
                Bash.Execute_Script("Stopping services", false, "systemctl stop SCNCORE_ORION-rmm-agent-remote");
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCORE_ORION-rmm-agent-health");
                Bash.Execute_Script("Stopping services", false, "systemctl stop SCNCORE_ORION-rmm-agent-health");
            }
            ...
            if (OperatingSystem.IsWindows())
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Comm.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION_RMM_Agent_Comm.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Remote.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION_RMM_Agent_Remote.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Health.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION_RMM_Agent_Health.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_User_Process.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION_RMM_User_Process.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_User_Process_UAC.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION_RMM_User_Process_UAC.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_User_Process.exe"); // kill legacy process
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCORE_ORION_RMM_User_Process.exe\""); // kill legacy process

                Thread.Sleep(5000); // Wait a little to allow service manager to release handles to prevent service marked for deletion error

                //Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"yara64.exe\""); // yara64.exe is (currently) not used in the project, its part of a SCNCORE_ORION legacy feature
                //Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"devcon_x64.exe\""); // devcon_x64.exe is (currently) not used in the project, its part of a SCNCORE_ORION legacy feature
            }
            else if (OperatingSystem.IsLinux())
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION-rmm-agent-comm");
                Bash.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION-rmm-agent-comm");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION-rmm-agent-remote");
                Bash.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION-rmm-agent-remote");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION-rmm-agent-health");
                Bash.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION-rmm-agent-health");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION-rmm-user-process");
                Bash.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION-rmm-user-process");
            }
            else if (OperatingSystem.IsMacOS())
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Comm");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCORE_ORION_RMM_Agent_Comm");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Remote");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCORE_ORION_RMM_Agent_Remote");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Health");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCORE_ORION_RMM_Agent_Health");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_User_Process");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCORE_ORION_RMM_User_Process");
            }
            ...
            if (OperatingSystem.IsWindows())
            {
                Logging.Handler.Debug("Main", "Deleting services.", "SCNCORE_ORION_RMM_Agent_Comm");
                Helper._Process.Start("cmd.exe", "/c sc delete SCNCORE_ORION_RMM_Agent_Comm");
                Logging.Handler.Debug("Main", "Deleting services.", "SCNCORE_ORION_RMM_Agent_Remote");
                Helper._Process.Start("cmd.exe", "/c sc delete SCNCORE_ORION_RMM_Agent_Remote");
                Logging.Handler.Debug("Main", "Deleting services.", "SCNCORE_ORION_RMM_Agent_Health");
                Helper._Process.Start("cmd.exe", "/c sc delete SCNCORE_ORION_RMM_Agent_Health");

                // Unregister user process
                Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Unregistering user process.");
                Logging.Handler.Debug("Main", "Unregistering user process", "SCNCORE_ORION_RMM_User_Process");
                Windows.Helper.Registry.HKLM_Delete_Value(Application_Paths.hklm_run_directory_reg_path, "SCNCORE_ORION_RMM_User_Process");
            }
            else if (OperatingSystem.IsLinux())
            {
        ...
        public static void Fix()
        {
            ...
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Comm");
                Zsh.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION_RMM_Agent_Comm");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Remote");
                Zsh.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION_RMM_Agent_Remote");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCORE_ORION_RMM_Agent_Health");
                Zsh.Execute_Script("Terminating processes", false, "pkill -f SCNCORE_ORION_RMM_Agent_Health");
            }
            Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Terminated processes.");
