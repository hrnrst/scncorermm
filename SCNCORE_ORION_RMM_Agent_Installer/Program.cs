    ...
    internal class Program
    {
        ...
        static async Task MainAsync(string[] args)
        {
            try
            {
                ...
                Console.Title = "SCNCORE_ORION RMM Agent Installer";
                Console.ForegroundColor = ConsoleColor.Red;
                string title = @"
 ____   ____ _   _  ____ ___  ____  _____ ___  ____  ___ ___  _   _ 
/ ___| / ___| \ | |/ ___/ _ \|  _ \| ____/ _ \|  _ \|_ _/ _ \| \ | |
\___ \| |   |  \| | |  | | | | |_) |  _|| | | | |_) || | | | |  \| |
 ___) | |___| |\  | |__| |_| |  _ <| |__| |_| |  _ < | | |_| | |\  |
|____/ \____|_| \_|\____\___/|_| \_\_____\___/|_| \_\___\___/|_| \_|
";
                ...
                // Create temp dir
                if (!Directory.Exists(Application_Paths.c_temp_SCNCORE_ORION_dir))
                    Directory.CreateDirectory(Application_Paths.c_temp_SCNCORE_ORION_dir);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + comm_package_url, Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.comm_agent_package_path), server_config_new.package_guid);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + remote_package_url, Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.remote_agent_package_path), server_config_new.package_guid);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + health_package_url, Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.health_agent_package_path), server_config_new.package_guid);
                ...
                if (OperatingSystem.IsWindows())
                {
                    http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + user_process_package_url, Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.user_process_package_path), server_config_new.package_guid);
                ...
                */
                ...
                string comm_agent_package_path = Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.comm_agent_package_path);
                ...
                if (comm_agent_package_hash_local == comm_agent_package_hash_local)
                {
                ...
                string remote_agent_package_path = Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.remote_agent_package_path);
                ...
                if (remote_agent_package_hash_local == remote_agent_package_hash_local)
                {
                ...
                string health_agent_package_path = Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.health_agent_package_path);
                ...
                if (health_agent_package_hash_local == health_agent_package_hash_local)
                {
                ...
                string user_process_package_path = Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.user_process_package_path);
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    if (user_process_package_hash_local == user_process_package_hash_local)
                    {
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.comm_agent_package_path), Application_Paths.program_files_comm_agent_dir, true);
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.remote_agent_package_path), Application_Paths.program_files_remote_agent_dir, true);
                ...
                if (arg1 == "clean")
                {
                    ...
                    ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.health_agent_package_path), Application_Paths.program_files_health_agent_dir, true);
                }
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_SCNCORE_ORION_dir, Application_Paths.user_process_package_path), Application_Paths.program_files_user_agent_dir, true);
                }
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    Process.Start("sc", "create SCNCORE_ORION_RMM_Agent_Comm binPath= \"" + Application_Paths.program_files_comm_agent_path + "\" start= auto").WaitForExit();
                    ...
                    Process.Start("sc", "create SCNCORE_ORION_RMM_Agent_Remote binPath= \"" + Application_Paths.program_files_remote_agent_path + "\" start= auto").WaitForExit();
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Process.Start("sc", "create SCNCORE_ORION_RMM_Agent_Health binPath= \"" + Application_Paths.program_files_health_agent_path + "\" start= auto").WaitForExit();
                ...
                else if (OperatingSystem.IsLinux())
                {
                    ...
                    Bash.Execute_Script("Registering remote agent as service", false,
                        "chmod +x /usr/0x101_Cyber_Security/SCNCORE_ORION_RMM/Comm_Agent/SCNCORE_ORION_RMM_Agent_Comm");

                    // Create service file for comm agent
                    Linux.Helper.Linux.CreateServiceFile(Application_Paths.program_files_comm_agent_service_config_path_linux, "SCNCORE_ORION-rmm-agent-comm", Application_Paths.program_files_comm_agent_service_path_unix, Application_Paths.program_files_comm_agent_dir, Application_Paths.program_files_comm_agent_service_log_path_unix);

                    Bash.Execute_Script("Registering comm agent as service", false,
                        "systemctl enable SCNCORE_ORION-rmm-agent-comm");
                    ...
                    // Set permissions
                    Bash.Execute_Script("Registering remote agent as service", false,
                        "chmod +x /usr/0x101_Cyber_Security/SCNCORE_ORION_RMM/Remote_Agent/SCNCORE_ORION_RMM_Agent_Remote");

                    // Create service file for remote agent
                    Linux.Helper.Linux.CreateServiceFile(Application_Paths.program_files_remote_agent_service_config_path_linux, "SCNCORE_ORION-rmm-agent-remote", Application_Paths.program_files_remote_agent_service_path_unix, Application_Paths.program_files_remote_agent_dir, Application_Paths.program_files_remote_agent_service_log_path_unix);

                    Bash.Execute_Script("Registering remote agent as service", false,
                        "systemctl enable SCNCORE_ORION-rmm-agent-remote");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Bash.Execute_Script("Registering health agent as service", false,
                            "chmod +x /usr/0x101_Cyber_Security/SCNCORE_ORION_RMM/Health_Agent/SCNCORE_ORION_RMM_Agent_Health");

                        // Create service file for health agent
                        Linux.Helper.Linux.CreateServiceFile(Application_Paths.program_files_health_agent_service_config_path_linux, "SCNCORE_ORION-rmm-agent_health", Application_Paths.program_files_health_agent_service_path_unix, Application_Paths.program_files_health_agent_dir, Application_Paths.program_files_health_agent_service_log_path_unix);

                        Bash.Execute_Script("Registering health agent as service", false,
                            "systemctl enable SCNCORE_ORION-rmm-agent-health");
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    Service.Start("SCNCORE_ORION_RMM_Agent_Comm");
                    ...
                    Service.Start("SCNCORE_ORION_RMM_Agent_Remote");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Service.Start("SCNCORE_ORION_RMM_Agent_Health");
                ...
                else if (OperatingSystem.IsLinux())
                {
                    ...
                    Logging.Handler.Debug("Main", "Starting comm agent service", "");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Starting comm agent service.");
                    Bash.Execute_Script("Starting comm agent service", false, "systemctl start SCNCORE_ORION-rmm-agent-comm");
                    Logging.Handler.Debug("Main", "Start comm agent service", "Done.");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Start comm agent service: Done.");
                    ...
                    Logging.Handler.Debug("Main", "Starting remote agent service", "");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Starting remote agent service.");
                    Bash.Execute_Script("Starting remote agent service", false, "systemctl start SCNCORE_ORION-rmm-agent-remote");
                    Logging.Handler.Debug("Main", "Start remote agent service", "Done.");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Start remote agent service: Done.");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Logging.Handler.Debug("Main", "Starting health agent service", "");
                        Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Starting health agent service.");
                        Bash.Execute_Script("Starting health agent service", false, "systemctl start SCNCORE_ORION-rmm-agent-health");
                        Logging.Handler.Debug("Main", "Start health agent service", "Done.");
                        Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Start health agent service: Done.");
                    }
                }
                ...
                Helper.IO.Delete_Directory(Application_Paths.c_temp_SCNCORE_ORION_dir);
