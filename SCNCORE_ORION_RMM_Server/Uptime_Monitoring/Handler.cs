...
namespace SCNCORE_ORION_RMM_Server.Uptime_Monitoring
{
    public class Handler
    {
        public static async Task Do(string identityJson, bool connected)
        {
            ...
            try
            {
                ...
                string description = connected ? "Connection to SCNCORE_ORION RMM server restored." : "The device lost connection to the SCNCORE_ORION RMM server.";
