...
namespace SCNCORE_ORION_RMM_Server.Files.Compiler
{
    public class Assembly_Manipulation
    {
        public static async Task<bool> Embedd_Server_Config(string path, string content)
        {
            ...
            {
                Logging.Handler.Error("SCNCORE_ORION_RMM_Server.Helper.Compiler.Ressource_Manipulation.Write_Ressource", "General error", ex.ToString());
